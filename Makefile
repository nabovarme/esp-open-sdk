...
VENDOR_SDK_DIR_2.2.x-778b145 = ESP8266_NONOS_SDK-2.2.x-778b145
...
$(VENDOR_SDK_DIR_2.2.0-master)/.dir:
	...
	(cd $(VENDOR_SDK_DIR_2.2.0-master); git checkout release/v2.2.x)
	touch $@

$(VENDOR_SDK_DIR_2.2.x-778b145)/.dir:
	echo $(VENDOR_SDK_DIR_2.2.x-778b145)
	git clone https://github.com/espressif/ESP8266_NONOS_SDK $(VENDOR_SDK_DIR_2.2.x-778b145)
	(cd $(VENDOR_SDK_DIR_2.2.x-778b145); git checkout 778b145)
	touch $@
...
.sdk_patch_2.2.x-778b145: user_rf_cal_sector_set.o
